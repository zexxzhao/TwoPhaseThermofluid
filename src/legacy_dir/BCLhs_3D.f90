...
!
!======================================================================
subroutine apply_bc(nsd, nshl, ix, bc, xKebe11, xGebe, xDebe1, xMebe, &
                    Rhsu, Rhsp, xLSebe, xLSUebe, xULSebe, xPLSebe, Rhsphi)
  ! use aAdjKeep
  ! use commonvars
  use class_def
...
!
!======================================================================
subroutine BCLhs_tem(nshl, ix, bc, xTebe, Rhs)
  ...
  integer, intent(in) :: nshl, ix(nshl)
  type(DirichletBCData), intent(in) :: bc
